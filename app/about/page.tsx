        ...
        <Container className="pt-24 pb-16 md:pt-32 md:pb-24">
            ...
            <div className="grid gap-12 md:grid-cols-2 md:items-center mb-24">
                ...
                <div className="space-y-5">
                    ...
                    <p className="text-muted-foreground leading-relaxed">
                        For us, it has always been beyond the fabrics. Our mission is to celebrate individuality by blending bold craftsmanship with a modern lifestyle, creating a community where everyone can wear their identity with pride. We are here to redefine the architecture of modern dress and establish a new era of bold, premium individuality.
                    </p>
